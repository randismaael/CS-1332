...
public class QuadraticProbingHashMapStudentTest {
    ...
    public void testNoIllegalCast() {
        QuadraticProbingHashMap<String, String> stringMap = new QuadraticProbingHashMap<>();
        stringMap.put("a", "a");
    ...
    @Test(timeout = TIMEOUT)
    public void testCharacterCountMap() {
        HashMap<Character, Integer> expected = new HashMap<>();
        expected.put('h', 1);
        expected.put('e', 1);
        expected.put('l', 2);
        expected.put('o', 1);
        assertEquals(expected, HashMapChallenge.characterCountMap("hello"));
    }

    @Test(timeout = TIMEOUT)
    public void testStringsAreAnagrams() {
        ArrayList<String> list = new ArrayList<>();
        list.add("aaba");
        list.add("abaa");
        assertTrue(HashMapChallenge.stringsAreAnagrams(list));

        list.set(1, "abba");
        assertFalse(HashMapChallenge.stringsAreAnagrams(list));
    }
}
